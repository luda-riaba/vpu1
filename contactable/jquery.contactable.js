...
(function($){
	...
	$.fn.contactable = function(options) {
		...
		var defaults = {
            ...
            page : location.href,
			submit : 'Відправити лист',
			recievedMsg : 'Дякуємо вам за лист',
			notRecievedMsg : 'Вибачте, але при відправленні листа стався збій, спробуйте пізніше',
			disclaimer: 'Будь-ласка, не соромтеся відправляти повідомлення, ми будемо дуже раді відповісти на всі ваші питання!',
			hideOnSubmit: true
